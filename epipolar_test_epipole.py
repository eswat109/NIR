...
if __name__ == '__main__':
    exp_number = 1;
    img1 = cv2.imread('img/{}l.jpg'.format(exp_number), cv2.IMREAD_GRAYSCALE)  # queryimage # left image
    img2 = cv2.imread('img/{}r.jpg'.format(exp_number), cv2.IMREAD_GRAYSCALE)  # trainimage # right image
